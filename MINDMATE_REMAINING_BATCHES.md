...
1. **Learn section (Option B — featured card on Home) — implemented locally 1 September 2026; validation pending.** Home now has a card between the Wellness card and Quick starts, opening a topic list with cards (title, one-line description, read-time hint) and a clean article reader. Six bundled static articles (no backend): (1) things that quietly support your mind; (2) things that quietly damage your mind; (3) substances and your brain — an honest conversation (cannabis, alcohol, codeine-based syrups, tramadol, inhalants; myth vs reality, non-preachy); (4) when "coping" becomes a problem (self-reflection questions, clearly not a diagnosis); (5) getting help in Nigeria (shame-free, hospital-based services, when to use emergency help, links into the app's Emergency Support); (6) if your friend is struggling (what to say/not say, when to involve an adult/professional). Voice matches the app: calm, honest, no fear-mongering, no medical advice; every reader ends with a button into an existing app tool. The developer PC analyzer has 0 errors/0 warnings and 23 informational notices. Three test runs reached 40/41 while the widget test was adjusted for lazily-built topic and reader cards; it now taps the visible first topic and scrolls to the reader’s next-step card, while the static content test covers all six topics. The test rerun is pending. Android/Web builds, Chrome/device validation, and the health-literate skim of articles 3–4 remain open.
